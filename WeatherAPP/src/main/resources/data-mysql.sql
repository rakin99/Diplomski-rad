...
INSERT INTO area(name_area, id_coord) VALUE('Zapadnobački okrug',1);
...
INSERT INTO area(name_area, id_coord) VALUE('Kolubarski okrug',2);
...
INSERT INTO area(name_area, id_coord) VALUE('Mačvanski okrug',3);
...
INSERT INTO area(name_area, id_coord) VALUE('Moravički okrug',4);
...
INSERT INTO area(name_area, id_coord) VALUE('Pomoravski okrug',5);
...
INSERT INTO area(name_area, id_coord) VALUE('Rasinski okrug',6);
...
INSERT INTO area(name_area, id_coord) VALUE('Raški okrug',7);
...
INSERT INTO area(name_area, id_coord) VALUE('Šumadijski okrug',8);
...
INSERT INTO area(name_area, id_coord) VALUE('Zlatiborski okrug',9);
...
INSERT INTO area(name_area, id_coord) VALUE('Borski okrug',10);
...
INSERT INTO area(name_area, id_coord) VALUE('Braničevski okrug',11);
...
INSERT INTO area(name_area, id_coord) VALUE('Jablanički okrug',12);
...
INSERT INTO area(name_area, id_coord) VALUE('Nišavski okrug',13);
...
INSERT INTO area(name_area, id_coord) VALUE('Pčinjski okrug',14);
...
INSERT INTO area(name_area, id_coord) VALUE('Pirotski okrug',15);
...
INSERT INTO area(name_area, id_coord) VALUE('Podunavski okrug',16);
...
INSERT INTO area(name_area, id_coord) VALUE('Toplički okrug',17);
...
INSERT INTO area(name_area, id_coord) VALUE('Zaječarski okrug',18);
...
INSERT INTO area(name_area, id_coord) VALUE('Srednjobanatski okrug',19);
...
INSERT INTO area(name_area, id_coord) VALUE('Severnobački okrug',20);
...
INSERT INTO area(name_area, id_coord) VALUE('Sevearenobanatski okrug',21);
...
INSERT INTO area(name_area, id_coord) VALUE('Južnobački okrug',22);
...
INSERT INTO area(name_area, id_coord) VALUE('Južnobanatski okrug',23);
...
INSERT INTO area(name_area, id_coord) VALUE('Sremski okrug',24);
...
INSERT INTO area(name_area, id_coord) VALUE('Kosovo',25);
...
INSERT INTO area(name_area, id_coord) VALUE('Kosovsko-Pomoravski okrug',26);
...
INSERT INTO area(name_area, id_coord) VALUE('Kosovskomitrovički okrug',27);
...
INSERT INTO area(name_area, id_coord) VALUE('Pećki okrug',28);
...
INSERT INTO area(name_area, id_coord) VALUE('Prizrenski okrug',29);
