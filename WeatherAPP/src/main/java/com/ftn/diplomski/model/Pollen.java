...
public class Pollen implements Serializable{
	...
	@Column(name = "id_pollen", nullable = false, unique = true)
	private Long id;
	...
	public Pollen(Long id, Long key, String name, Long iD2, boolean ascending, Date localDateTime, Date epochDateTime,
