...
@Service
public class WordConverterService implements WordConverterInterface{

	private static char[] cyrilic = new char[] {
			'\u0410', 	'\u0430',	//A
			'\u0411',	'\u0431',	//B
			'\u0412', 	'\u0432',	//V
			'\u0413', 	'\u0433',	//G
	...
	private static Map<Character, String> cyrMapping = new HashMap<Character, String>();

	
	private static Map<String, Character> latMapping = new HashMap<String, Character>();
